...
public class SetV2Gegner extends Kartenset<Charakterkarte>
{
	public SetV2Gegner()
	{
		...
		neueKarte(new Charakterkarte("Giftpilz", 9, 11, 7, 8, 12, 142,
				new ZTEBuilder(NKartentyp.CHARAKTER).setStartTrigger(StartTrigger.IMMER_NACH).setBetrifftGegner(true)
		...
		neueKarte(new Charakterkarte("Blocko", 7, 8, 3, 8, 10, 24,
				new ZTEBuilder(NKartentyp.CHARAKTER).setStartTrigger(StartTrigger.IMMER_NACH)
		...
		neueKarte(new Charakterkarte("Minimagier", 6, 8, 6, 5, 6, 16,
				new ZTEBuilder(NKartentyp.CHARAKTER).setStartTrigger(StartTrigger.ANFANG)
		...
		neueKarte(new Charakterkarte("Rächer", 7, 8, 7, 9, 7, 48,
				new ZTEBuilder(NKartentyp.CHARAKTER).setStartTrigger(StartTrigger.IMMER_VOR).setBedingungen(new BLebenIst(Vergleich.KG, 10))
		...
		neueKarte(new Charakterkarte("Energi", 9, 12, 8, 6, 12, 177,
				...
				new ZTEBuilder(NKartentyp.CHARAKTER).setStartTrigger(StartTrigger.IMMER_VOR)
		...
		neueKarte(new Charakterkarte("Klingo", 8, 8, 9, 6, 6, 37,
				new ZTEBuilder(NKartentyp.CHARAKTER).setStartTrigger(StartTrigger.EINMAL_NACH)
