...
public class ZTEBuilder
{
	...
	private Kartentyp an;
	private W zielWaffe = W.OK;
	private Wirkung wirkung;

	public ZTEBuilder(Kartentyp auf)
	{
		this.auf = auf;
		an = auf;
	}
	...
	public ZTEBuilder setAn(Kartentyp an)
	{
		this.an = an;
		return this;
	}
	...
	public ZTEBuilder generateText()
	{
		...
		else
		{
			...
			if(an == Kartentyp.CHARAKTER && auf == Kartentyp.WAFFE)
			{
				sb.append("Anwender: ");
			}
		}
