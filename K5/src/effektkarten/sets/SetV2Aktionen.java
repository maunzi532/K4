...
public class SetV2Aktionen extends KartensetBuilder<Aktionskarte>
{
	public SetV2Aktionen()
	{
		...
		neueKarte(new Aktionskarte("Brecher", -1, 2, -3, true,
				new ZTEBuilder(EffektZielKartentyp.AKTION).setStartTrigger(StartTrigger.EINMAL_NACH)
		...
		neueKarte(new Aktionskarte("Konter", 1, -2, 0, false,
				new ZTEBuilder(EffektZielKartentyp.AKTION).setStartTrigger(StartTrigger.IMMER_VOR).setBedingungen(new BWurdeAngegriffen())
		...
		neueKarte(new Aktionskarte("Wut", 1, 1, -2, false,
				new ZTEBuilder(EffektZielKartentyp.AKTION).setStartTrigger(StartTrigger.EINMAL_VOR)
		...
		neueKarte(new Aktionskarte("Kombination", 2, 2, -4, false,
				new ZTEBuilder(EffektZielKartentyp.AKTION).setStartTrigger(StartTrigger.IMMER_VOR).setBedingungen(new BZielVonTeamAngegriffen())
						.setWirkung(StatWirkung.angriff(4)).setEndTrigger(EndTrigger.NACH_ANGRIFF).createZTE()));
		neueKarte(new Aktionskarte("Eisschlag", -1, 0, 0, false,
				new ZTEBuilder(EffektZielKartentyp.AKTION).setStartTrigger(StartTrigger.EINMAL_NACH).setBetrifftGegner(true)
		...
		neueKarte(new Aktionskarte("Aufladung", 1, -8, 0, false,
				new ZTEBuilder(EffektZielKartentyp.AKTION).setStartTrigger(StartTrigger.GES_NACH).setAn(
		...
		neueKarte(new Aktionskarte("Hinterhalt", 0, 4, -2, false,
				new ZTEBuilder(EffektZielKartentyp.AKTION).setStartTrigger(StartTrigger.IMMER_NACH)
