...
public class SetV2Waffen extends Kartenset<Waffenkarte>
{
	public SetV2Waffen()
	{
		...
		neueKarte(new Waffenkarte("Fortgeschrittener Hammer", 12, 11, 2, Karte.alleKlassen,
				false, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.ZUGENDE)
						.setWirkung(new WNichtVerwendbar()).setDauer(2).createZTE()));
		neueKarte(new Waffenkarte("Giftbogen", 12, 0, 8, 0b01000001,
				true, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.IMMER_NACH)
		...
		neueKarte(new Waffenkarte("Fortgeschrittener Auslassstab", 13, 4, 6, Karte.alleKlassen,
				true, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.GES_VOR).setBedingungen(new BMagieAusgeben())
						.setWirkung(new StatWirkung(2, 2, 2, 0, 2)).createZTE()));
		neueKarte(new Waffenkarte("Luftwaffe", 13, 4, 8, 0b00010100,
				true, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.GES_NACH).setBedingungen(new BGesVorteil(5))
						.setWirkung(StatWirkung.angriff(4)).createZTE()));
		neueKarte(new Waffenkarte("Kristall der Macht", 14, 9, 4, 0b00100100,
				true, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.GES_NACH)
		...
		neueKarte(new Waffenkarte("Steinschleuder", 11, 3, 7, 0b01010011,
				true, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.IMMER_NACH).setBetrifftGegner(true)
						.setAn(NKartentyp.CHARAKTER).setWirkung(StatWirkung.angriff(-3)).createZTE()));
		neueKarte(new Waffenkarte("Fortgeschrittene Waffe", 12, 7, 5, Karte.alleKlassen, true));
		neueKarte(new Waffenkarte("Stange", 5, 4, 1, Karte.alleKlassen, true));
		neueKarte(new Waffenkarte("Speer", 11, 4, 6, 0b11010001,
				true, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.VERWENDET).setBedingungen(new BHauptwaffe())
		...
		neueKarte(new Waffenkarte("Politurfaust", 7, 4, 3, 0b00001000,
				true, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.GES_NACH).setBedingungen(new BMagieAusgeben())
						.setWirkung(StatWirkung.mindestschutz(1)).createZTE()));
		neueKarte(new Waffenkarte("Schleimkanone", 9, 2, 4, 0b00000110,
				true, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.EINMAL_NACH).setBetrifftGegner(true)
		...
		neueKarte(new Waffenkarte("Ozonsplitter", 12, 0, 12, 0b00011110,
				true, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.VERWENDET)
		...
		neueKarte(new Waffenkarte("Etwas kleiner Stock", 9, 2, 7, Karte.alleKlassen, true));
		neueKarte(new Waffenkarte("Anfängerschwert", 5, 2, 3, Karte.alleKlassen, true));
		neueKarte(new Waffenkarte("Hammer", 7, 7, 3, 0b11001000,
				false, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.ZUGENDE)
						.setWirkung(new WNichtVerwendbar()).setDauer(2).createZTE()));
		neueKarte(new Waffenkarte("Windstab", 7, 3, 4, 0b00110001,
				true, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.GES_VOR).setBetrifftGegner(true)
		...
		neueKarte(new Waffenkarte("Wasserstein", 8, 2, 3, 0b00010010,
				true, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.IMMER_NACH).setBetrifftGegner(true).setAn(NKartentyp.CHARAKTER)
		...
		neueKarte(new Waffenkarte("Magische Kugel", 7, 2, 4, 0b00100110,
				true, new ZMEBuilder(NKartentyp.WAFFE).setMagieKosten(2).setBetrifftGegner(true).setAn(NKartentyp.CHARAKTER)
		...
		neueKarte(new Waffenkarte("Stärkungsbogen", 10, 4, 7, 0b01000000,
				true, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.IMMER_NACH).setBedingungen(new BHauptwaffe())
						.setWirkung(StatWirkung.angriff(3)).createZTE()));
		...
		neueKarte(new Waffenkarte("Silberdolch", 14, 3, 9, 0b11110110,
				true, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.GES_VOR)
		...
		neueKarte(new Waffenkarte("Kleiner Stock", 9, 1, 8, Karte.alleKlassen, true));
		neueKarte(new Waffenkarte("Wasserstab", 11, 8, 4, 0b00100010,
				true, new ZMEBuilder(NKartentyp.WAFFE).setMagieKosten(2)
		...
		neueKarte(new Waffenkarte("Beschwörungsstab", 8, 4, 3, 0b00000001,
				true, new ZTEBuilder(NKartentyp.WAFFE).setStartTrigger(StartTrigger.EINMAL_NACH)
