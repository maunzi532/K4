...
public class SetV2Aktionen extends Kartenset<Aktionskarte>
{
	public SetV2Aktionen()
	{
		...
		neueKarte(new Aktionskarte("Disruptorangriff", -3, -2, 4, true,
				new ZTEBuilder(Kartentyp.AKTION).setStartTrigger(StartTrigger.IMMER_NACH).setBetrifftGegner(true)
		...
		neueKarte(new Aktionskarte("Ausholen", -3, 0, 0, false,
				new ZTEBuilder(Kartentyp.AKTION).setStartTrigger(StartTrigger.ZUGENDE).setAn(Kartentyp.WAFFE)
		...
		neueKarte(new Aktionskarte("Konter", 1, -2, 0, false,
				new ZTEBuilder(Kartentyp.AKTION).setStartTrigger(StartTrigger.IMMER_VOR).setBedingungen(new BWurdeAngegriffen())
		...
		neueKarte(new Aktionskarte("Powerstoß", -2, 1, 6, false,
				new ZTEBuilder(Kartentyp.AKTION).setStartTrigger(StartTrigger.IMMER_NACH).setBetrifftGegner(true)
						.setAn(Kartentyp.CHARAKTER).setWirkung(StatWirkung.verteidigung(5)).createZTE()));
		...
		neueKarte(new Aktionskarte("Wut", 1, 1, -2, false,
				new ZTEBuilder(Kartentyp.AKTION).setStartTrigger(StartTrigger.EINMAL_VOR)
		...
		neueKarte(new Aktionskarte("Kombination", 2, 2, -4, false,
				new ZTEBuilder(Kartentyp.AKTION).setStartTrigger(StartTrigger.IMMER_VOR).setBedingungen(new BZielVonTeamAngegriffen())
						.setWirkung(StatWirkung.angriff(4)).setEndTrigger(EndTrigger.NACH_ANGRIFF).createZTE()));
		neueKarte(new Aktionskarte("Eisschlag", -1, 0, 0, false,
				new ZTEBuilder(Kartentyp.AKTION).setStartTrigger(StartTrigger.EINMAL_NACH).setBetrifftGegner(true)
						.setAn(Kartentyp.CHARAKTER).setWirkung(StatWirkung.geschwindigkeit(-2)).setDauer(3).createZTE()));
		...
		neueKarte(new Aktionskarte("Schnellschwung", 1, 0, 0, false,
				new ZTEBuilder(Kartentyp.AKTION).setStartTrigger(StartTrigger.GES_NACH)
						.setBedingungen(new BBasisWertIst(Basiswert.GESCHWINDIGKEIT, Kartentyp.WAFFE, Vergleich.GG, 5))
		...
		neueKarte(new Aktionskarte("Aufladung", 1, -8, 0, false,
				new ZTEBuilder(Kartentyp.AKTION).setStartTrigger(StartTrigger.GES_NACH).setAn(Kartentyp.CHARAKTER)
		...
		neueKarte(new Aktionskarte("Hinterhalt", 0, 4, -2, false,
				new ZTEBuilder(Kartentyp.AKTION).setStartTrigger(StartTrigger.IMMER_NACH)
		...
		neueKarte(new Aktionskarte("Geschwindigkeitsbelohnung", 2, -2, 0, false,
				new ZTEBuilder(Kartentyp.AKTION).setStartTrigger(StartTrigger.GES_NACH)
						.setBedingungen(new BBasisWertVergleich(Basiswert.GESCHWINDIGKEIT, Kartentyp.CHARAKTER, Vergleich.G))
						.setWirkung(StatWirkung.angriff(2)).createZTE(),
				new ZTEBuilder(Kartentyp.AKTION).setNum(1).setStartTrigger(StartTrigger.GES_NACH)
						.setBedingungen(new BBasisWertVergleich(Basiswert.GESCHWINDIGKEIT, Kartentyp.WAFFE, Vergleich.G))
						.setWirkung(StatWirkung.angriff(2)).createZTE(),
				new ZTEBuilder(Kartentyp.AKTION).setNum(2).setStartTrigger(StartTrigger.GES_NACH)
						.setBedingungen(new BBasisWertVergleich(Basiswert.GESCHWINDIGKEIT, Kartentyp.AKTION, Vergleich.G))
						.setWirkung(StatWirkung.angriff(2)).createZTE()));
	}
}